...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleFitnessException(FitnessException exception, HttpServletRequest httpServletRequest){
